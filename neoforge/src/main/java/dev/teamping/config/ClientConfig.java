...
public final class ClientConfig {
    ...
    /**
     * Когда команды нет: показывать свои метки всем, кто рядом.
     *
     * <p>Выключено. Без команды метка видна только автору — так же, как вейпоинт.
     * Переключается галочкой в меню меток, радиус задаёт сервер.
     */
    public boolean shareWithNearby = false;
    /**
